...
The first stage of the calibration uses the MONSTER reference catalog, a composite all-sky dataset cross-calibrated from SkyMapper, Pan-STARRS, Gaia~XP, and other surveys.
